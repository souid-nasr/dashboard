...
import { FormsUniversity } from "./components/FormsUniversity";
// import NewInstitution from './components/NewInstitution.js'
import NewInstitution from './components/Test2.js'
export default () => {
  return (
    <>
